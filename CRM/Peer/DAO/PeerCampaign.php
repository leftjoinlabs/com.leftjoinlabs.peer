 ...
 * (GenCodeChecksum:1ff5e91750527bf4956e4e7c31a55807)
 */
...
class CRM_Peer_DAO_PeerCampaign extends CRM_Core_DAO {
  ...
  /**
   * The function used to aggregate peer fulfillment records to compute a total for each page associated with this campaign (e.g. 'sum', 'count')
   *
   * @var string
   */
  public $total_function;
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'total_function' => [
          'name' => 'total_function',
          'type' => CRM_Utils_Type::T_STRING,
          'title' => ts('Total Function'),
          'description' => 'The function used to aggregate peer fulfillment records to compute a total for each page associated with this campaign (e.g. \'sum\', \'count\')',
          'required' => TRUE,
          'maxlength' => 255,
          'size' => CRM_Utils_Type::HUGE,
          'default' => 'sum',
          ...
          'pseudoconstant' => [
            'callback' => 'CRM_Peer_BAO_PeerCampaign::totalFunctionOptions',
          ]
        ],
