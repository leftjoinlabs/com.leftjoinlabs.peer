 ...
 * (GenCodeChecksum:93840f5e9aa3a44adf8a65b95717c2a8)
 */
...
class CRM_Peer_DAO_PeerCampaign extends CRM_Core_DAO {
  ...
  /**
   * The function used to aggregate peer fulfillment records to compute a total for each page associated with this campaign
   *
   * @var string
   */
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'total_function' => [
          ...
          'description' => 'The function used to aggregate peer fulfillment records to compute a total for each page associated with this campaign',
          'required' => TRUE,
          'maxlength' => 255,
          'size' => CRM_Utils_Type::HUGE,
          'table_name' => 'civicrm_peer_campaign',
