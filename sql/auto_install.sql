...
CREATE TABLE `civicrm_peer_campaign` (
     ...
     `total_function` varchar(255) NOT NULL  DEFAULT 'sum' COMMENT 'The function used to aggregate peer fulfillment records to compute a total for each page associated with this campaign (e.g. \'sum\', \'count\')',
     ...
     `is_active` tinyint   DEFAULT 1 COMMENT 'Is Peer Campaign Page Block enabled/active?' 
,
        PRIMARY KEY (`id`)
